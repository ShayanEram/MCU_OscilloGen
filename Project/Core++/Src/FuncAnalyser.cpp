...
float32_t FuncAnalyser::measurePeakVoltage() {
...
void FuncAnalyser::computeFFT(float32_t* fftOutput) {
...
void FuncAnalyser::applyLowPassFilter(float32_t* output) {
...
float32_t FuncAnalyser::findMaxPeak() {
    float32_t maxPeak;
